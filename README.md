...
| **[defined-mcp](./plugins/defined-mcp)** | Defined Networking / Managed Nebula MCP integration for coding and DevOps agents — inspect and manage networks, hosts, enrollment codes, roles, firewall rules, tags, routes, audit logs, downloads, and host diagnostics. |
